...
class RandomLogic(BaseLogic):
    ...
    def next_move_antara(self, board_bot: GameObject, board: Board):
        props = board_bot.properties.mill
        current_position = board_bot.position
        print("Diamonds")
        print(board.g)
        print(board_bot.properties.base)
        print(board_bot.properties.can_tackle)
        print(board_bot.properties.inventory_size)
        maks_indeks = self.getNearestDiamonds(board_bot, board)
        print(maks_indeks)
        print(board.diamonds[maks_indeks].position)
